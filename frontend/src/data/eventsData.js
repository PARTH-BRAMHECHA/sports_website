const eventsData = [
  {
    ...
    description: "Annual mega sports festival featuring multiple sports competitions. Join us for four days of excitement, competition, and celebration of sports excellence.",
    startDate: "2024-02-24",
    endDate: "2024-02-27",
    venue: "PICT Campus Ground",
    sports: ["Basketball", "Volleyball", "Chess", "Table Tennis", "Carrom"],
    type: "elevate",
  ...
  },
  {
    ...
    sports: ["Cricket", "Basketball", "Volleyball", "Table Tennis", "Carrom", "Chess"],
    type: "intra",
