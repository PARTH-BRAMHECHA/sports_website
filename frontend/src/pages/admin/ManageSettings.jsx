...
const ManageSettings = () => {
  ...
  const handleToggleRegistration = async () => {
    try {
      ...
      setSuccess(`Registration has been ${updatedRegistrationStatus ? 'enabled' : 'disabled'} successfully`);
    } catch (error) {
                  ...
                  label={
                    <Box sx={{ ml: 1 }}>
                      <Typography variant="body1">
                        {settings.registrationEnabled ? 'Registration is Currently Enabled' : 'Registration is Currently Disabled'}
                      </Typography>
